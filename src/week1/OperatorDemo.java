...
public class OperatorDemo 
{
	...
	public static void main(String[] args) 
	{
		...
		//u & v = 198 , P & q = 870, i=48, r=137, s=138
		...
		System.out.println("less than equal to <= : "+(p<=s));
		System.out.println(v<=u);//true
		System.out.println("equal to / comparision operator== : "+(s==r));//false
