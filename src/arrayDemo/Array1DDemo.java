...
//		sid[4]=105;
		...
		//System.out.println(sid[5]);//ArrayIndexBoundsException
		
	System.out.println("********************************");	
		 
	//Iterate array using simple for loop
	...
	//	studentName[2]="Abhi";
		...
		System.out.println("Total student: "+studentName.length);
	...
	//	marks[2]=34.78;
		...
		System.out.println("Totalmarks are: "+(marks[0]+marks[1]));
	...
	Object empdata[]= {"Sarang","Pune","M",40, 9876567890L,89.90};
